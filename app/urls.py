...
#from app.StaffEditResult import StaffEditResult
from .import HodViews, StaffViews, StudentViews, ResultViews, pdfviews
...
urlpatterns = [
    ...
    path('student_pdf/',HodViews.GeneratePDF.as_view(),name="student_pdf"),
    #path('export/',exportviews.export,name="student_export"),
    ...
    path('add_term/', HodViews.add_term, name="add_term"),
    path('add_term_save/', HodViews.add_term_save, name="add_term_save"),
    path('manage_term/', HodViews.manage_term, name="manage_term"),
    path('edit_term/<term_id>/', HodViews.edit_term, name="edit_term"),
    path('edit_term_save/', HodViews.edit_term_save, name="edit_term_save"),
    path('delete_term/<term_id>/', HodViews.delete_term, name="delete_term"),
    
    path("site-config", HodViews.SiteConfigView.as_view(), name="configs"),
    path("current-session/", HodViews.CurrentSessionAndTermView.as_view(), name="current-session"
    ),

    path("upload/", HodViews.StudentBulkUploadView.as_view(), name="student-upload"),
    path("download-csv/", HodViews.DownloadCSVViewdownloadcsv.as_view(), name="download-csv"),

    path("result_create/", HodViews.create_result, name="result_create"),
    path("result_edit/", HodViews.result_edit, name="result-edit"),
    path("result_view/", HodViews.ResultListView.as_view(), name="result_view"),
    ...
    #Invoice
    path("invoice/list/", HodViews.InvoiceListView.as_view(), name="invoice-list"),
    path("invoice/create/", HodViews.InvoiceCreateView.as_view(), name="invoice-create"),
    path("invoice/<int:pk>/detail/", InvoiceDetailView.as_view(), name="invoice-detail"),
    ...
    path("invoice/create/", HodViews.InvoiceCreateView.as_view(), name="invoice-create"),
    path("invoice/receipt/create", HodViews.ReceiptCreateView.as_view(), name="receipt-create"),
    path(
        "invoice/receipt/<int:pk>/update/", ReceiptUpdateView.as_view(), name="receipt-update"
    ),
    path("invoice/bulk-invoice/", bulk_invoice, name="bulk-invoice"),
